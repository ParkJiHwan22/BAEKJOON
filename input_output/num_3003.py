...
# 예제 입력: 0 1 2 2 2 7    2 1 2 1 2 1
# 예제 출력: 1 0 0 0 0 1   -1 0 0 1 0 7
...
for i in range(6):
    print(lst[i]-input_[i], end=' ')

# 앞으로는 아래 식처럼 리스트와 반복문을 이용하여 코드 짜볼 것
# map 함수는 여러 요소에 하나의 함수를 한꺼번에 대응시켜줄 수 있다.